...
const CharacterCursor: React.FC<CharacterCursorProps> = ({
  ...
  characterScalingFunction = (age, lifeSpan) =>
    Math.max(((lifeSpan - age) / lifeSpan) * 1.5, 0),
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      canvas.style.zIndex = zIndex ? zIndex.toString() : '0';
      ...
      characters.forEach((char) => {
        ...
        if (bgContext) {
          bgCanvas.width = measurements.width + 10;
          bgCanvas.height = 40;
    ...
    const onMouseMove = (e: MouseEvent) => {
      ...
      if (wrapperElement) {
        ...
        // Only add particle if mouse is inside the wrapper
